    ...
    var O = function (h) {
        ...
        function (a) {
            ...
            fnHeaderCallback: null, fnInfoCallback: null, fnInitComplete: null, fnPreDrawCallback: null, fnRowCallback: null, fnServerData: null, fnServerParams: null, fnStateLoadCallback: function (a) { try { return JSON.parse((-1 === a.iStateDuration ? sessionStorage : localStorage).getItem("DataTables_" + a.sInstance + "_" + location.pathname)) } catch (b) { } }, fnStateLoadParams: null, fnStateLoaded: null, fnStateSaveCallback: function (a, b) {
                ...
                oAria: { sSortAscending: ": activate to sort column ascending", sSortDescending: ": activate to sort column descending" }, oPaginate: { sFirst: "First", sLast: "Last", sNext: "Trang sau", sPrevious: "Trang trước" }, sEmptyTable: "No data available in table", sInfo: "Hiển thị _START_ đến _END_ trong _TOTAL_ bản ghi", sInfoEmpty: "Hiển thị 0 đến 0 trong 0 bản ghi", sInfoFiltered: "(filtered from _MAX_ total bản ghi)",
                sInfoPostFix: "", sDecimal: "", sThousands: ",", sLengthMenu: "Hiển thị _MENU_ bản ghi", sLoadingRecords: "Loading...", sProcessing: "Processing...", sSearch: "Tìm kiếm:", sSearchPlaceholder: "", sUrl: "", sZeroRecords: "No matching records found"
